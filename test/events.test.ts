...
describe("Given: Event", () => {
    ...
    it("When Event then defaultMaxListeners should be eql 10", () => {
    ...
    describe("Given: on(eventName, listener)", () => {
        ...
        it("When listenerCount(eventName) then listenerCount should eql ++ previous listenerCount", () => {
            let event = new Event();
            let listener = sinon.spy();
            let eventName = "eventName";
        ...
        it("When emit(eventName) then listener should listener()", () => {
           let event = new Event();
           let listener = sinon.spy();
           let eventName = "eventName";
           event.on(eventName, listener);
        ...
        it("When on(eventName, listener2) then emit(eventName) should listener1() and listener2()", () => {
            let event = new Event();
